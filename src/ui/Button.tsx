...
function Button({ children, disabled, style, type, to }: ButtonProps) {
  ...
  const styles = {
    ...
    secondary:
      'hover:bg-neutral-800 focus:outline-none focus:ring focus:ring-neutral-500 focus:ring-opacity-50 focus:ring-offset-2 disabled:cursor-not-allowed inline-block font-semibold tracking-wide uppercase transition-colors duration-300 rounded-full border-2 border-neutral-500 px-4 py-2.5 md:px-6 md:py-3.5',
  };
